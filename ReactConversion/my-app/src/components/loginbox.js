// loginbox.js
// Removed TypeScript-specific code.
// Replaced useAppSelector with the Redux useSelector hook.
// Removed AppDispatch type as we're not using TypeScript anymore.
// Replaced Link from next/link with Link from react-router-dom.
// The necessary routes should be set up for React Router's Link to work

import React, { useEffect } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { Link } from 'react-router-dom';
import { checkAuthAPI, loginAPI } from '@/functions/auth';
import { login, setEmail, setPassword } from '@/redux/features/auth-slice';
