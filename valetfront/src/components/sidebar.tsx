...
export default function Sidebar({
  ...
  return (
    <div>
          ...
          <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0 w-1/5 min-w-auto" aria-label="Sidebar">
                ...
                <ul className="space-y-2 font-medium">
                  ...
                  <li>
                      <Link href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-black">3</span>
                      </Link>
                  </li>
                  {/* <li>
